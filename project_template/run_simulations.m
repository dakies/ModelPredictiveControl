...
% sgtitle('simulate truck(T0 1, @controller mpc 2, scen1)')
% figure
% 
% % % T13
...
simulate_truck(T0_1, @controller_mpc_3, scen2);
sgtitle('simulate truck(T0 1, @controller mpc 3, scen1)');
...
% display(strcat('Forces: ', num2str(t_sim_forces),' Yalmip: ', num2str(t_sim_)))